...
export const mockDunningSequences = [
  {
    ...
    description: "5-step email sequence with increasing urgency — from friendly reminder to final notice.",
    is_default: true,
    is_active: true,
...
export const mockDunningEmails = [
  {
    ...
    body_html: "<p>Hi there,</p><p>We just tried to process your payment, but it was declined. This happens sometimes — expired cards, bank holds, the usual.</p><p>The good news: it only takes a minute to fix. Just update your payment method and you're all set.</p>",
    body_text: "We just tried to process your payment, but it was declined. Update your payment method to fix it.",
  ...
  },
  {
    ...
    body_html: "<p>Hi there,</p><p>Just a quick follow-up — your recent payment is still outstanding. We'd hate for you to lose access to your account over a card issue.</p>",
    body_text: "Your recent payment is still outstanding. Please update your payment method.",
    is_ai_generated: false,
  ...
  },
  {
    ...
    body_html: "<p>Hi there,</p><p>We've attempted to charge your card a few times now, but it keeps getting declined. Your subscription is still active, but we'll need a valid payment method to keep it going.</p>",
    body_text: "We've attempted to charge your card a few times. Please update your payment details.",
    is_ai_generated: false,
  ...
  },
  {
    ...
    body_html: "<p>Hi there,</p><p>We've been trying to reach you about a failed payment. Your subscription will be cancelled soon if we can't collect payment.</p>",
    body_text: "Your subscription will be cancelled soon if we can't collect payment. Please update your payment method now.",
    is_ai_generated: false,
    created_at: "2026-01-20T10:03:00Z",
  },
  {
    id: "mock-email-5",
    sequence_id: "mock-seq-1",
    ...
    body_html: "<p>Hi there,</p><p>This is our final attempt to recover your payment. Your account will be cancelled within 48 hours unless you update your payment method.</p>",
    body_text: "Final notice: your account will be cancelled within 48 hours unless you update your payment method.",
    is_ai_generated: false,
    created_at: "2026-01-20T10:04:00Z",
  },
];
